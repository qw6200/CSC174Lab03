...
<body>
    ...
    <h1>Sustenance</h1>
    <p>While watermelons, tea and chocolate are all very different, they have in common the fact that they can be eaten or drunk for nourishment.  Therefore, the domain is Sustenance.  Things that fall under the category of sustenance have a number of different things in common, a few of which are described below in triples.  These are not all the relationships that define sustenance, but they will be the focus of this collection of information.</p>
    <ul>
    ...
    <p>Watermelon fruit is 91% water, contains 6% sugars, and is low in fat (table).[50] In a 100 gram serving, watermelon fruit supplies 30 calories and low amounts of essential nutrients (table). Only vitamin C is present in appreciable content at 10% of the Daily Value (table). Watermelon pulp contains carotenoids, including lycopene.[51]  The amino acid citrulline is produced in watermelon rind.[52][53]</p>
    
    <h3>Processing</h3>
    <p>Watermelon is barely processed before consumption.  One merely cuts into the thick rind to get at the soft fruit underneath.</p>
    
    
    <h2>Tea<h2>
    <h3>Basic Description</h3>
    <p>Tea is an aromatic beverage commonly prepared by pouring hot or boiling water over cured leaves of the Camellia sinensis, an evergreen shrub (bush) native to East Asia.[3] After water, it is the most widely consumed drink in the world.[4] There are many different types of tea; some, like Darjeeling and Chinese greens, have a cooling, slightly bitter, and astringent flavour,[5] while others have vastly different profiles that include sweet, nutty, floral or grassy notes.</p>
    
    <h3>Nutritional Value</h3>
    <p>Without adding any milk or sugar, tea has 0 calories and provides no real nutritional value.  It has been claimed to have a lot of antioxidants though.</p>
    
    <h3>Processing</h3>
    <p>Teas of different levels of oxidation (L to R): green, yellow, oolong, and black. Tea is generally divided into categories based on how it is processed.[83] At least six different types are produced:</p>
    <ul>
