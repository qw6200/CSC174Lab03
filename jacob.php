...
<body>
    ...
    <main>
        <h1>Cat Breeds</h1>
        <p>Cats have been domesticated and bred for thousands of years. Breeds' exact date of origin are usually a mystery as there is always numerous conflicting data whether from the Roman times or the Aztecs. Regardless, cats have been an integral part of human society since ancient times. Although there aren't many cat breeds like those of dogs, there are still distinct personality traits as well as physical distinctions between each cat breed. We will explore some of the most popular breeds (as well as those I like the most) and what makes them distinct but similar with one another.</p>

        <h2>British Shorthair<h2>
        <h3>History</h3>
        <p>The origins of the British Shorthair most likely date back to the first century AD, making it one of the most ancient identifiable cat breeds in the world. It is thought that the invading Romans initially brought Egyptian domestic cats to Great Britain; these cats then interbred with the local European wildcat population. Over the centuries, their naturally isolated descendants developed into distinctively large, robust cats with a short but very thick coat, the better to withstand conditions on their native islands. Based on artists' representations, the modern British Shorthair is basically unchanged from this initial type.</p>

        <h3>Traits</h3>
        <p>They are an easygoing and dignified breed, not as active and playful as many but sweet-natured and devoted to their owners, making them a favourite of animal trainers. They tend to be safe around other pets and children since they will tolerate a fair amount of physical interaction.</p>
